...
- (void)adLinkClicked:(NSURL *)URL
{
	...
	MPAdBrowserController *browserController = [[MPAdBrowserController alloc] initWithURL:desiredURL 
																				 delegate:self];
	[[self.delegate viewControllerForPresentingModalView] presentViewController:browserController animated:YES completion:nil];
...
{
	NSString *result = nil;
	NSString *udid = [NSString stringWithFormat:@"mopub-%@", [[UIDevice currentDevice] identifierForVendor]];
